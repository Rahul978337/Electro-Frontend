        ...
        <div className="row gx-0 bg-primary px-5 align-items-center">
                  ...
                  <ul className="list-unstyled categories-bars">
                    {
                      categoryName.map((value) =>
                        ...
                        <li>
                          <Link to={`/shop?_id=${value._id}`} className='text-decoration-none text-dark'>
                            <div className="categories-bars-item">{value.name}
          ...
          <div className="col-12 col-lg-9">
            ...
            <Link  to={"/shop"} className="nav-item nav-link">
             ...
             <Link  to={ "/SinglePage"}className="nav-item nav-link">
                Single Page
              </Link>
